...
export class W3C {
    ...
    async project(
        ...
        const res = await this.client.fetch(
            `/identifiers/${name}/w3c/projections`,
            'POST',
    ...
    async projection(
        ...
        const res = await this.client.fetch(
            `/identifiers/${name}/w3c/projections/${encodeURIComponent(sessionId)}`,
            'GET',
            null
        );
        return await res.json();
    ...
    async requests(
        ...
        for (const aidName of names) {
            ...
            const res = await this.client.fetch(
                `/identifiers/${aidName}/w3c/signing-requests${query}`,
                'GET',
                null
            );
            const body = await res.json();
    ...
    async submitSignature(
        ...
        const res = await this.client.fetch(
            `/identifiers/${request.name}/w3c/signing-requests/${encodeURIComponent(request.d)}/signatures`,
            'POST',
            { signature }
        );
        return await res.json();
